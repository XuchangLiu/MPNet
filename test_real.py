...
parser.add_argument("--logdir", type=str, default="/root/autodl-tmp/PReNet1/logs/real", help='path to model and log files')
parser.add_argument("--data_path", type=str, default="/root/autodl-tmp/PReNet1/datasets/real", help='path to training data')
parser.add_argument("--save_path", type=str, default="results/real/", help='path to save results')
parser.add_argument("--use_GPU", type=bool, default=True, help='use GPU or not')
parser.add_argument("--gpu_id", type=str, default="0", help='GPU id')
parser.add_argument("--which_model", type=str, default="net_latest.pth", help='model name')
