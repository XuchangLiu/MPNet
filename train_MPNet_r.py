...
parser.add_argument("--save_path", type=str, default="logs/MPNet", help='path to save models and log files')
...
def main():
    ...
    # Build model
    model = MPNet_r(recurrent_iter=opt.recurrent_iter, use_GPU=opt.use_gpu)
    print_network(model)
