...
parser = argparse.ArgumentParser(description="MPNet_train")
...
parser.add_argument("--save_path", type=str, default="logs/MPNet_test", help='path to save models and log files')
parser.add_argument("--save_freq",type=int,default=1,help='save intermediate model')
parser.add_argument("--data_path",type=str, default="/root/autodl-tmp/MPNet/datasets/train/Rain12600/Rain12600",help='path to training data')
...
def main():
    ...
    # Build model
    model = MPNet(recurrent_iter=opt.recurrent_iter, use_GPU=opt.use_gpu)
    print_network(model)
