...
parser.add_argument("--data_path", type=str, default="/root/autodl-tmp/PReNet1/datasets/test/Rain100H/Rain100H/rainy", help='path to training data')
parser.add_argument("--save_path", type=str, default="/root/autodl-tmp/PReNet1/results/PReNet", help='path to save results')
